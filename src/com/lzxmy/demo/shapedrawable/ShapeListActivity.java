...
public class ShapeListActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int type = intent.getIntExtra(ShapeMainActivity.TYPE, DrawableProvider.SAMPLE_RECT);
    ...
    private class SampleAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                convertView = View.inflate(ShapeListActivity.this, R.layout.shape_item_layout, null);
