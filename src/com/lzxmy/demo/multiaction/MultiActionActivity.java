 ...
 */
public class MultiActionActivity extends Activity{
    ...
    private final String TAG = MultiActionActivity.class.getSimpleName();

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.multiaction_layout);
...
//    public MultiActinActivity(MyMultiActionClickListener myMultiActionClickListener) {
//        this.myMultiActionClickListener = myMultiActionClickListener;
//    }
